// process.env["NODE_TLS_REJECT_UNAUTHORIZED"] = 0; //this is insane, i should not have had to do this. oh, i didn't hit TRUST in local. cool.
...
export function filterTracksByGenre(tracks, activeGenre) {
	//create new array, then loop through old array and filter results into new array. Then return new array
	let filteredTracks = [];

	if (activeGenre === "All") {
		//if the active genre is all, return all of the tracks
